...
| Dimension                  | Analysis                                                                                                                                                                                                                                                                                                      |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Data needed**            | `games` (home_club_goals, away_club_goals, date, competition_id, home_club_formation, away_club_formation, season, round), `game_lineups` (starting_lineup only: player_id, player_name, position, number), `players` (name for guessing), `clubs` (name for display), `competitions` (name for display), `national_teams` (name + confederation — national-team competitions are seeded into the Club table per the Dev 2 curated-set design)      |
...
_Report prepared for `specifier` to begin task decomposition._
