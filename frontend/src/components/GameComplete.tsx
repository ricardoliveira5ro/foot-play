...
export default function GameComplete({ match, targetShirts, opponentShirts, targetTeamName, opponentTeamName, revealedPlayers, onPlayAgain }: Readonly<GameCompleteProps>) {
