...
export interface TeamColorEntry {
  ...
  /** When true, the shirt number gets a thin black outline so it stays readable on striped/halved shirts. */
...
const TEAM_COLORS: Record<number, TeamColorEntry> = {
  ...
  13:  { primary: '#CB3524', secondary: '#FFFFFF', pattern: 'stripes-v', numberOutline: true },   // Atlético de Madrid
  ...
  11:  { primary: '#DB0007', secondary: '#FFFFFF', pattern: 'solid' },       // Arsenal FC
  148: { primary: '#FFFFFF', secondary: '#132257', pattern: 'solid' },       // Tottenham Hotspur
  631: { primary: '#034694', secondary: '#002F6C', pattern: 'solid' },       // Chelsea FC
  985: { primary: '#C70101', secondary: '#FFFFFF', pattern: 'solid' },       // Manchester United

  // Bundesliga
  27:  { primary: '#DC052D', secondary: '#FFFFFF', pattern: 'solid' },       // Bayern Munich

  // Serie A
  506: { primary: '#000000', secondary: '#FFFFFF', pattern: 'stripes-v', numberOutline: true },   // Juventus
  ...
  // Ligue 1
  583: { primary: '#004170', secondary: '#002654', pattern: 'solid' },       // Paris Saint-Germain

  // Primeira Liga
  294: { primary: '#E83030', secondary: '#FFFFFF', pattern: 'solid' },       // SL Benfica
  336: { primary: '#00843D', secondary: '#FFFFFF', pattern: 'stripes-h', numberOutline: true },   // Sporting CP
  720: { primary: '#003893', secondary: '#FFFFFF', pattern: 'stripes-v', numberOutline: true },   // FC Porto

  // National Teams
  3300: { primary: '#E42518', secondary: '#0D6938', pattern: 'solid' },      // Portugal
  3375: { primary: '#AA151B', secondary: '#FABD00', pattern: 'solid' },      // Spain
  3377: { primary: '#00539B', secondary: '#FFFFFF', pattern: 'solid' },      // France
  3262: { primary: '#FFFFFF', secondary: '#000000', pattern: 'solid' },      // Germany
  3299: { primary: '#FFFFFF', secondary: '#E31837', pattern: 'solid' },      // England
